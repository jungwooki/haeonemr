// Generated from src/data/mental/catalog.json.
var MENTAL_SPORT_KEYS = ["student", "soccer", "adult_soccer", "baseball", "basketball", "volleyball", "golf", "ballet", "gymnastics", "ice_skating", "ice_hockey", "taekwondo", "squash"];
